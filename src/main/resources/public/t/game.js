        ...
        success: function(resources) {
            ...
            webSocket.onmessage = function(message) {
                ...
                if (message.cmd == "OUTPUT") {
                    ...
                    if (background.startsWith("#") && actualBackground !== background) {
                        canvasContext.fillStyle = background;
                        canvasContext.fillRect(0, 0, canvas.width, canvas.height);
                    } else if (actualBackground !== background) {
            ...
            function show_image(src, x, y) {
                try {
                    canvasContext.drawImage(images["./img/" + src + ".png"], x * 16, y * 32);
                } catch (e) {
                    canvasContext.drawImage(images["./img/error.png"], x * 16, y * 32);
